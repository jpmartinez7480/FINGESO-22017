<%-- 
    Document   : generar_compromiso
    Created on : 30-11-2017, 9:38:22
    Author     : JuanPablo
--%>
...
<body>
	...
	<div class = "container">
		...
		<div class = "col-sm-9">
                    <div class = "well">
			<h4>Declaración de compromisos Docentes</h4>
                        <form method="post" action = "DocenciaServlet" class="form-hotizontal">
                            <div class ="row">
                                <div class ="col-sm-8">
                                    <div class = "col-sm-2">
                                        <p>Año</p>
                            ...
                            <hr>
                            <div class="form-group asignaturaForm">
                                <div class ="col-sm-12">
                                    <div class ="col-sm-3">
                                        <input type ="text" class ="form-control" name="nombre[]" placeholder="Curso" style = "margin-bottom: 5px;"/>
                                    </div>
                                    <div class ="col-sm-3">
                        ...
                        <div class ="form-group asignaturaFormCopy" style="display:none;">
                            <div class ="col-sm-12">
                                <div class ="col-sm-3">
                                    <input type ="text" class ="form-control" name="nombre[]" placeholder="Curso" style = "margin-bottom: 5px;"/>
                                </div>
...
<script>
    $(document).ready(function(){
       ...
       $(".addButton").click(function(){
           if($('body').find('.asignaturaForm').length < max){
               var fieldHTML = '<div class="form-group asignaturaForm">'+$(".asignaturaFormCopy").html()+'</div>';
               $('body').find('.asignaturaForm:last').after(fieldHTML);
           }
           else{
       ...
       $('body').on('click','.remove',function(){
           $(this).parents('.asignaturaForm').remove();
       });
